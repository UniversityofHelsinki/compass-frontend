...
const FooterLinks = () => {
    ...
    return (
        <ul>
            ...
            <li><ExternalLink to={t('footer_compass_instructions_link')} label={t('footer_compass_instructions_link_label')}/></li>
            <li><ExternalLink to={t('footer_compass_link')} label={t('footer_compass_link_label')}/></li>
            <li><ExternalLink to={t('footer_accessibility_statement_link')} label={t('footer_accessibility_statement_link_label')}/></li>
            <li><Feedback to="mailto:self-reflection-compass@helsinki.fi" label={t('footer_compass_feedback')}/></li>
