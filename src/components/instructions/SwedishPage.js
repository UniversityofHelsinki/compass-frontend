        ...
        <div>
            ...
            <p>
                <span lang="sv">
                    ...
                    som kräver etisk sensitivitet. Det kan var svårt för läraren att veta hur
                    undervisning i forskningsetik inverkar på studerandes vilja att förhålla sig
                    reflektivt och agera enligt god vetenskaplig praxis. Dessutom kan studenter
                    förlita sig på AI-verktyg för att slutföra uppgifter – vilket ofta är okej, men
                    om det görs utan egen tankeverksamhet och reflektion är det tveksamt vad
                    studenterna verkligen har lärt sig. Lärare kan önska att de kunde undvika
                    oönskad användning av AI och samtidigt hålla sig underrättade om studenternas
                    lärandeprocess utan att bli överbelastade med uppgifter att läsa.
                </span>
            </p>
            ...
            <p>
                <span lang="sv">
                    ...
                    av läraren. Tidsspannet indikera när studenterna kan göra uppgifterna. Lärare
                    kan också duplicera sina kurser och uppgifter och använda dem under kommande
                    terminer. Kurserna ges ett unikt ID som hjälper till att skilja mellan olika år
                    och grupper.
                </span>
            </p>
            ...
            <p>
                <span lang="sv">
                    ...
                    uppgift varpå hen reflekterar över sitt eget kunnande och indikerar sin
                    förståelse genom att välja ett av fem alternativ som bäst beskriver förståelsen.
                    Efter att ha skickat in sitt svar får studenten automatiserad feedback som
                    beskriver den förståelsenivå de har valt. Applikationen uppmuntrar studenterna
                    reflektera över huruvida den förståelsenivå som beskrivs i den automatiserade
                    återkopplingen motsvarar deras egen uppfattning. Studenten kan gå tillbaka till
                    och redigera antingen den egna svarstexten eller förståelsenivån.
                </span>
            </p>
            ...
            <p>
                <span lang="sv">
                    ...
                    'reflektionsdagbok'. Diagrammet fungerar som en sammanfattning över
                    lärandeprocessen och kan användas för vidare reflektioner i dagboken.
                    Reflektionsdagboken kan användas för summativ bedömning, det vill säga som en
                    betygsatt uppgift som bidrar till den slutliga bedömningen i kursen.
                </span>
            </p>
            ...
            <p>
                <span lang="sv">
                    ...
                    diagrammet, och genom att läsa feedbacken som ges av applikationen och
                    eventuellt också läraren, utveckla självutvärderingskompetensen.
                </span>
            </p>
            ...
            <p>
                ...
                <span lang="sv">
                    ...
                    och sedan granska frågan från berörda parters synvinklar, vilket kan hjälpa
                    studenten att bredda insyn i vad annat som kan ingå i temat/frågan.{' '}
                </span>
            </p>
            ...
            <p>
                <span lang="sv">
                    ...
                    av nivåerna för förståelse samt i den automatiserade feedbacken. Genom
                    visualiseringarna som applikationen producera och genom att följa med svaren
                    studenterna ger på kursuppgifterna vid olika tidpunkter under kursens gång, kan
                    läraren få en helhetsbild av studenternas lärande samt information om hur
            ...
            <p>
                <span lang="EN-US">
                    Artikel: John Biggs (1999) What the Student Does: teaching for enhanced
            ...
            <p>
                <span lang="EN-US">
                    Artikel: Anu Tammeleht &amp; Erika Löfström (2024) Learners’ self-assessment as
