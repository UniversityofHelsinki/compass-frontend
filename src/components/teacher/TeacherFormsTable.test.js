...
const courses = [
    ...
    },
    {
        ...
        description:
            'KUVAUSTA ON KERRAKSEEN LOREM IPSUM LOREM IPSUM LOREMP IPSUKUVAUSTA ON KERRAKSEEN LOREM IPSUM LOREM IPSUM LOREMP IPSUKUVAUSTA ON KERRAKSEEN LOREM IPSUM LOREM IPSUM LOREMP IPSUM',
...
test('rendering', () => {
    render(
        <TeacherFormsTable teacherForms={courses} sortOpts={{}} onSortCriteriaChange={() => {}} />,
    );
});
