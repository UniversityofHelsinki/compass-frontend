...
const DeleteStudentAnswer = () => {
    ...
    const showAssignment = () => {
        return (
            ...
            <Container>
                <Row>
                    <Col className="delete-student-answer-title">
                        {studentAnswer.title}
                    </Col>
                </Row>
                <Row>
    ...
    return (
        <>
            {showAssignment()}
            <DeleteStudentAnswerFooter disabled={disabled} answer={answer} course={studentAnswer?.course_id} id={id} deleteAnswer={removeStudentAnswer}></DeleteStudentAnswerFooter>
